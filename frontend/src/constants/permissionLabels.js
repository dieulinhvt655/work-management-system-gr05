...
export const PERMISSION_LABELS = {
  ...
  [PERMISSIONS.MY_TEAM_READ]: 'Xem team của tôi',
  [PERMISSIONS.MY_TEAM_MEMBERS_READ]: 'Xem thành viên team',
  ...
  [PERMISSIONS.PROJECTS_ACTIVITY_READ]: 'Xem hoạt động dự án (danh sách)',
